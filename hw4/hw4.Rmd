...
For the training sets, the maximum accuracy for data set 0/1 is at 1 at all learning rates, for data set 3/5 is at 0.966351209253417 at learning rate 0.1. For the testing sets, the maximum accuracy for data set 0/1 is at 1 at learning rates 0.7, for testing data set 3/5 is at 0.956887486855941 at learning rate 0.4.. Note these numbers might change per run. 
...
From the learning curves, there is a general pattern that as we increase the training set size, the accuracy for the testing set increases. This makes sense as when we have more traning samples, our model is more well trained and hence will do better on the testing sets. 
