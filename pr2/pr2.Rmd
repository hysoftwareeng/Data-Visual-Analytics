...
###### Process Actors #############
actors = unlist(strsplit(df_cat$Actor, ','))
...
df_cat$Actors_mod = tolower(gsub(' ', '', df_cat$Actor))
if ("Actor" %in% colnames(df_cat)){
  df_cat = subset(df_cat, select=-c(Actor))
}
