...
df_cat = subset(df2, select=c(Genre, Director, Writer, Actors, Country, Awards, Production, Gross))
...
productions = names(sort(table(productions), decreasing = TRUE)[1:6])
...
# }
# df_cat = subset(df_cat, select=-c(Awards))
