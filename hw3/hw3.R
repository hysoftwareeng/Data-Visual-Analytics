...
cat(sprintf("Dimension of train_0_1 are %i by %i: ", dim(train_0_1)[1], dim(train_0_1)[2]))
cat(sprintf("Dimension of train_3_5 are %i by %i: ", dim(train_3_5)[1], dim(train_3_5)[2]))
cat(sprintf("Dimension of test_0_1 are %i by %i: ", dim(test_0_1)[1], dim(test_0_1)[2]))
cat(sprintf("Dimension of test_3_5 are %i by %i: ", dim(test_3_5)[1], dim(test_3_5)[2]))
